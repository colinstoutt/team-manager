...
This app needs authentication. Along with that will be the ability to create your team, those two go hand in hand. The 'upcoming game' seciton on the index page currently does not display the correct data. Need to get Heroku up and running. 
